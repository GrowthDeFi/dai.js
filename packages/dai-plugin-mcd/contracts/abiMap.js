...
module.exports = {
  ...
  FUSDT: require('./abis/DSToken.json'),
  LQDR: require('./abis/DSToken.json'),
  MIM: require('./abis/DSToken.json'),
  SPIRIT: require('./abis/DSToken.json'),
  FRAX: require('./abis/DSToken.json'),
  MAI: require('./abis/DSToken.json'),
  BOO: require('./abis/DSToken.json'),
  SUSHI: require('./abis/DSToken.json'),
  LINK: require('./abis/DSToken.json'),
  SCREAM: require('./abis/DSToken.json'),
  ...
  SPIFTMLQDR: require('./abis/DSToken.json'),
  SPIFTMFUSDT: require('./abis/DSToken.json'),
  SPIFTMWBTC: require('./abis/DSToken.json'),
  SPIFTMUSDC: require('./abis/DSToken.json'),
  SPIFTMWETH: require('./abis/DSToken.json'),
  SPIFTMMIM: require('./abis/DSToken.json'),
  SPIFTMSPIRIT: require('./abis/DSToken.json'),
  SPIFTMFRAX: require('./abis/DSToken.json'),
  SPIFTMMAI: require('./abis/DSToken.json'),
  SPOFTMBOO: require('./abis/DSToken.json'),
  SPOFTMUSDC: require('./abis/DSToken.json'),
  SPOFTMDAI: require('./abis/DSToken.json'),
  SPOFTMSUSHI: require('./abis/DSToken.json'),
  SPOFTMLINK: require('./abis/DSToken.json'),
  SPOFTMWETH: require('./abis/DSToken.json'),
  SPOFTMFUSDT: require('./abis/DSToken.json'),
  SPOFTMMIM: require('./abis/DSToken.json'),
  SPOFTMSCREAM: require('./abis/DSToken.json'),
  STKSPIFTMLQDR: require('./abis/DSToken.json'),
  STKSPIFTMFUSDT: require('./abis/DSToken.json'),
  STKSPIFTMWBTC: require('./abis/DSToken.json'),
  STKSPIFTMUSDC: require('./abis/DSToken.json'),
  STKSPIFTMWETH: require('./abis/DSToken.json'),
  STKSPIFTMMIM: require('./abis/DSToken.json'),
  STKSPIFTMSPIRIT: require('./abis/DSToken.json'),
  STKSPIFTMFRAX: require('./abis/DSToken.json'),
  STKSPIFTMMAI: require('./abis/DSToken.json'),
  STKSPOFTMBOO: require('./abis/DSToken.json'),
  STKSPOFTMUSDC: require('./abis/DSToken.json'),
  STKSPOFTMDAI: require('./abis/DSToken.json'),
  STKSPOFTMSUSHI: require('./abis/DSToken.json'),
  STKSPOFTMLINK: require('./abis/DSToken.json'),
